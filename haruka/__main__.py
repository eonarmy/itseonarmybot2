...
def send_start(bot, update):
    ...
    text = "Hey there! My name is EONARMY - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "Join [EONARMY](https://t.me/eonarmy) \n\n\
 \n\n\
Made with ❤Love by @XHACKERKUNAL \n\nWant to add me to your group? [Click here!](t.me/HarukaAyaBot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="📢 Our Channel", url="https://t.me/eonarmy")]]
